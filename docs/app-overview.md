...
- `packages/terminal-web`: browser terminal emulator API, Ghostty/libghostty WASM loader and snapshot adapter, fallback parser/screen model, DOM renderer, and input mapper for the experimental chat-side terminal panel.
