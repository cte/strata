...
>(({ index, className, mask, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "relative flex h-9 w-9 items-center justify-center border-y border-r border-hairline text-sm shadow-sm transition-all first:rounded-l-md first:border-l last:rounded-r-md",
