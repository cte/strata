...
export const PromptInputSelectTrigger = ({
  ...
  <SelectTrigger
    className={cn(
      "border-none bg-transparent font-medium text-fg-mute shadow-none transition-colors",
      "hover:bg-surface-2 hover:text-fg aria-expanded:bg-surface-2 aria-expanded:text-fg",
      className,
    )}
    {...props}
  />
...
export const PromptInputTabLabel = ({ className, ...props }: PromptInputTabLabelProps) => (
  ...
  <h3 className={cn("mb-2 px-3 font-medium text-xs text-fg-mute", className)} {...props} />
);
...
export const PromptInputTabItem = ({ className, ...props }: PromptInputTabItemProps) => (
  <div
    className={cn("flex items-center gap-2 px-3 py-2 text-xs hover:bg-surface-2", className)}
    {...props}
  />
);
