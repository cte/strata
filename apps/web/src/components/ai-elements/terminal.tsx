...
export const TerminalCopyButton = ({
  ...
  className,
  ...props
}: TerminalCopyButtonProps): ReactElement => {
  ...
  return (
    <Button
      className={cn(
        "size-7 shrink-0 text-zinc-400 hover:bg-zinc-800 hover:text-zinc-100 [&>svg]:!size-[13px]",
        className,
      )}
...
export const TerminalClearButton = ({
  ...
  className,
  ...props
}: TerminalClearButtonProps): ReactElement | null => {
...
export const TerminalContent = ({
  ...
  children,
  ...props
}: TerminalContentProps): ReactElement => {
